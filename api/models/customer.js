...
class Customer{
    ...
    addCustomer(req, res){
        try {
            ...
            connectionPool.query(`INSERT IGNORE into sales.customer(name, mobile, company_name, 
    ...
    getCustomer(req, res){
        try {
            ...
            connectionPool.query(`SELECT * FROM sales.customer where id = ? and user_id = ?`,
    ...
    deleteCustomer(req, res){
        try {
            ...
            connectionPool.query(`DELETE FROM sales.customer where id = ? and user_id = ?`,
                [req.params.customer_id, req.user_id], function(error, result, fields) {
                    if (error) {
                        res.status(500).send({
                            status: "error",

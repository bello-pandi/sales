...
console.log(config.get('database.user'))
...
class Invoice {
    ...
    addInvoice(req, res) {
        try {
            ...
            connectionPool.query(`INSERT INTO sales.invoice (${columnList.join(', ')}) VALUES 
                ...
                if (error) {
                    ...
                    connectionPool.query(`INSERT INTO sales.invoice_product (invoice_id,product_id,quantity,rate) VALUES 
    ...
    getInvoice(req, res) {
        try {
            ...
            connectionPool.query(`SELECT inv.*, ip.*, pr.name product_name, cst.name customer_name, cst.email customer_email, cst.company_name customer_company_name, usr.mobile user_mobile,usr.email user_email,usr.name user_name,usr.company_name user_company_name,usr.company_address user_company_address
                                  FROM sales.invoice inv, sales.invoice_product ip, sales.product pr, sales.customer cst, sales.user usr

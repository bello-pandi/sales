...
class Product{
    ...
    addProduct(req, res){
        try {
            ...
            connectionPool.query(`INSERT into sales.product(name,label,description,rate ,sku,user_id) 
    ...
    getProducts(req, res){
        try {
            ...
            connectionPool.query(`SELECT * FROM sales.product where user_id = ?`, req.user_id,
    ...
    getProduct(req, res){
        try {
            ...
            connectionPool.query(`SELECT * FROM sales.product where id = ? and user_id = ?`,
